...
// It is important, to mock the environment only for development purposes. When
// building the
// application, import.meta.env.DEV will become false, and the code inside will
// be tree-shaken,
...
if (import.meta.env.DEV) {
  if (!await isTMA('complete')) {
    ...
    mockTelegramEnv({
      onEvent(e) {
        // Here you can write your own handlers for all known Telegram Mini Apps
        // methods:
      ...
      launchParams: new URLSearchParams([
        ...
        //
        // Note that to make sure, you are using a valid init data, you must pass
        // it exactly as it
        // is sent from the Telegram application. The reason is in case you will
        // sort its keys
        // (auth_date, hash, user, etc.) or values your own way, init data validation
        // will more
        // likely to fail on your server side. So, to make sure you are working
        // with a valid init
        // data, it is better to take a real one from your application and paste
        // it here. It should
